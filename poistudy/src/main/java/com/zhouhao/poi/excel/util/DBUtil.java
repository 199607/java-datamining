package com.zhouhao.poi.excel.util;

import com.google.common.base.Joiner;
import com.zhouhao.poi.excel.bean.CreateTable;
import com.zhouhao.poi.excel.bean.XCell;
...
public class DBUtil {
    ...
    private static String db = "datamining";
    private static String name = "root";
    private static String password = "root";
    private static String tableName = "guangdon2";
     ...
     * 1.创建数据库表
     */
    public static void createTable(String sb) {
        Connection conn = getConnection();
        Statement stmt;
        try {
            stmt = conn.createStatement();
            if (0 == stmt.executeLargeUpdate(sb)) {
    ...
    public static CreateTable generateCreateTable(XRow xRow) {
        ...
        createTable.setColumnList(dbColumnList);
        createTable.setCreateStr(sb.toString());
        return createTable;
    }
